...
class UserSeeder extends Seeder
{
    ...
    // ************ USUARIOS PRUEBAS DEL SISTEMA *******************
        ...
        User::create(['IdEmp' => '726', 'name' =>'ANTONIO MUNIVE CONTRERAS','Departamento' => 7,'password' => bcrypt('726')]);
        User::create(['IdEmp' => '792', 'name' =>'CESAR ROJAS MORALES','Departamento' => 7,'password' => bcrypt('792')]);
        User::create(['IdEmp' => '858', 'name' =>'FRANCISCO JAVIER MENDIETA RODRIGUEZ','Departamento' => 7,'password' => bcrypt('858')]);
        User::create(['IdEmp' => '862', 'name' =>'FELIPE PEREZ JUAREZ','Departamento' => 7,'password' => bcrypt('862')]);
        User::create(['IdEmp' => '924', 'name' =>'JAVIER MELENDEZ ROMERO','Departamento' => 7,'password' => bcrypt('924')]);
        User::create(['IdEmp' => '929', 'name' =>'JOSE MANUEL RAMIREZ CALDERON','Departamento' => 7,'password' => bcrypt('929')]);
        User::create(['IdEmp' => '930', 'name' =>'SERGIO BRANDON LOPEZ GONZALEZ','Departamento' => 7,'password' => bcrypt('930')]);
        User::create(['IdEmp' => '983', 'name' =>'CESAR VICTORIANO HERNANDEZ','Departamento' => 7,'password' => bcrypt('983')]);
        User::create(['IdEmp' => '994', 'name' =>'BERNARDO BERNALDINO HERNANDEZ','Departamento' => 7,'password' => bcrypt('994')]);
        User::create(['IdEmp' => '1004', 'name' =>'JUAN DAVID SERRANO HERNANDEZ','Departamento' => 7,'password' => bcrypt('1004')]);
        User::create(['IdEmp' => '1053', 'name' =>'JULIO ROJAS OLAYA','Departamento' => 7,'password' => bcrypt('1053')]);
        User::create(['IdEmp' => '1054', 'name' =>'EMILIO MUÑOZ XICOHTENCATL','Departamento' => 7,'password' => bcrypt('1054')]);
        User::create(['IdEmp' => '1098', 'name' =>'EDGAR IVAN AGUILAR FERNANDEZ','Departamento' => 7,'password' => bcrypt('1098')]);
        User::create(['IdEmp' => '1161', 'name' =>'PAULINO TORRES GUZMAN','Departamento' => 7,'password' => bcrypt('1161')]);
        User::create(['IdEmp' => '1166', 'name' =>'JUAN CARLOS OCHOA MARTINEZ','Departamento' => 7,'password' => bcrypt('1166')]);
        User::create(['IdEmp' => '1173', 'name' =>'JONATHAN AGUILAR CARO','Departamento' => 7,'password' => bcrypt('1173')]);
        User::create(['IdEmp' => '1193', 'name' =>'RAMIRO ISLAS CHAVEZ','Departamento' => 7,'password' => bcrypt('1193')]);
        User::create(['IdEmp' => '1210', 'name' =>'JUAN JOSE JARAMILLO SILVA','Departamento' => 7,'password' => bcrypt('1210')]);
        User::create(['IdEmp' => '1244', 'name' =>'EMMANUEL GUTIERREZ LOZADA','Departamento' => 7,'password' => bcrypt('1244')]);
