...
class TurnosEquiposInviernoApertura extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Invierno:Equipos';
     ...
     * @var string
     */
    protected $description = 'Cambio de turno y equipos en apertura invierno';
    ...
    public function handle()
    {
        ...
        Storage::disk('local')->put('Equipo.txt', $txt);
