                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr align="center">
                                    <td colspan="2" style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-size: 16px; font-weight: 400; line-height: 25px;">
                                        <p>Tienes una petición de autorizacion por parte de Sistemas</p>
                                    </td>
                                </tr>
                                <tr>
                                    <th align="left" valign="top" style="padding-left:25px;padding-right:15px;padding-bottom:10px; font-size: 14px; font-weight: 600; line-height: 25px;">Folio: </th>
                                    <td align="left" valign="top" style="padding-left:1px;padding-right:30px;padding-bottom:10px; font-size: 12px; font-weight: 500; line-height: 25px;">
                                    S-{{ $Sis->Folio }} </td>
                                </tr>
                                <tr>
                                    <th align="left" valign="top" style="padding-left:25px;padding-right:15px;padding-bottom:10px; font-size: 14px; font-weight: 600; line-height: 25px;">Departamento: </th>
                                    <td align="left" valign="top" style="padding-left:1px;padding-right:30px;padding-bottom:10px; font-size: 12px; font-weight: 500; line-height: 25px;">
                                    {{ $Sis->Departamento }} </td>
                                </tr>
                                <tr>
                                    <th align="left" valign="top" style="padding-left:25px;padding-right:15px;padding-bottom:10px; font-size: 14px; font-weight: 600; line-height: 25px;">Solicitante: </th>
                                    <td align="left" valign="top" style="padding-left:1px;padding-right:30px;padding-bottom:10px; font-size: 12px; font-weight: 500; line-height: 25px;">
                                    {{ $Sis->Solicitante }} </td>
                                </tr>
                                <tr align="center">
                                    <td colspan="2" style="padding-top:25px; padding-left:30px;padding-right:15px;padding-bottom:10px; font-size: 16px; font-weight: 600; line-height: 30px;">
                                        <a style="text-decoration: none; cursor: pointer; color:#0284C7" href="https://intranethlangeles.com/Sistemas/CotizacionSistemas">Accede ingresando al siguiente enlace</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
