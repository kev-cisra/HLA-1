                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr align="center">
                                    <td colspan="2" style="padding-left:30px;padding-right:15px;padding-bottom:10px; font-size: 16px; font-weight: 400; line-height: 25px;">
                                        <p>La siguiente solicitud de vacaciones fue aprobada por:  {{ $Vac->AutorizadoPor }}</p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr align="center">
                                    <td colspan="2" style="padding-top:25px; padding-left:30px;padding-right:15px;padding-bottom:10px; font-size: 16px; font-weight: 600; line-height: 30px;">
                                        <a style="text-decoration: none; cursor: pointer; color:#0284C7" href="https://intranethlangeles.com/RecursosHumanos/Vacaciones">Revisalas en el siguiente enlace</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
