...
use App\Mail\Sistemas\AvisoCotizacionMailable;
...
class CotizacionesSistemasController extends Controller{
    ...
    public function index(Request $request){
        ...
        return Inertia::render('Sistemas/Requisiciones/CotizacionesSistemas', compact('Session','Departamentos','Perfiles','Proveedores','CotizacionSistemas','RequisicionesSistemas', 'RequisicionSistemas'));
    }
    ...
    public function update(Request $request, $id){
        ...
        switch ($request->Metodo) {
            case 1: //Confirma Cotizacion
                    ...
                    $DatosCorreo->Departamento = $request->departamento['Nombre'];
                    $DatosCorreo->Solicitante = $request->perfil['Nombre'] .' '.$request->perfil['ApPat'].' '.$request->perfil['ApMat'];
                    $DatosCorreo->Folio = $request->Folio;

                    $correo = new AvisoCotizacionMailable($DatosCorreo);
