<template>
    <app-layout>
        ...
        <modal :show="showDetalle" @close="chageDetalle" maxWidth="3xl">
            <div class="ModalHeader">
                <h3 class="tw-p-2"><i class="tw-ml-3 tw-mr-3 fas fa-scroll"></i>S-{{form.Folio}}</h3>
            </div>
            ...
            <div class="ModalForm">
                ...
                <div class="FormSection">
                    <div class="tw-px-3 tw-mb-6 md:tw-w-full md:tw-mb-0">
                        ...
                        <input type="number" min="1" class="InputDinamico" v-model="form.CostoExtra" v-on:click="Moneda(form.CostoExtra)">
                    </div>
                </div>
                <div class="FormSection">
                    <div class="tw-px-3 tw-mb-6 md:tw-w-full md:tw-mb-0">
        ...
        <modal :show="showCotizacion" @close="chageCotizacion" maxWidth="3xl">
            <div class="ModalHeader">
                <h3 class="tw-p-2"><i class="tw-ml-3 tw-mr-3 fas fa-scroll"></i>Cotización S-0{{RequisicionSistemas.Folio}}</h3>
            </div>
