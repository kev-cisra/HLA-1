    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <jet-input id="IdEmp" type="text" class="block w-full mt-1" v-model="form.IdEmp" required autofocus autocomplete="IdEmp" />
            </div>
            ...
            <div>
                ...
                <jet-input id="Area" type="text" class="block w-full mt-1" v-model="form.Area" required autofocus autocomplete="Area" />
            </div>
