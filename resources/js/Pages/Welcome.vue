<template>
    <div class="tw-relative tw-flex tw-justify-center tw-min-h-screen tw-bg-gray-100 tw-items-top dark:tw-bg-gray-900 sm:tw-items-center sm:tw-pt-0">
        ...
        <div class="tw-max-w-6xl tw-mx-auto sm:tw-px-6 lg:tw-px-8">
            ...
            <div class="tw-mt-8 tw-overflow-hidden tw-bg-white tw-shadow dark:tw-bg-gray-800 sm:tw-rounded-lg">
