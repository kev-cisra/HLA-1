...
export default {
    ...
    methods: {
        ...
        Ticket(data){
            ...
            ventana.document.write('<p>Proveedor:<strong style="font-weight: bold;">'+' '+data.requisicion_articulos[0].articulo_precios[0].Proveedor+'</strong></p>');
            ...
            ventana.document.write('<p>Total:<strong style="font-weight: bold;">'+' $'+TotalRequisicion+'</strong></<p>');
            ventana.document.write('<p style="font-size: 12px; text-align: right; font-weight: bold;">'+ moment().format('DD/MM/YYYY HH:mm')+'</<p>');
            ventana.document.write('</div>');
