                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <table class="table-body">
                            ...
                            <tr><th style="text-align: justify; text-transform: uppercase; opacity: 0.8; padding-left: 20px; padding-right: 15px;">
                                <p>
                                    Es importante que en su factura se anoten los siguientes datos para el proceso correcto de pago.
                                </p>
                            </th></tr>
                            <tr><th style="text-align: justify; text-transform: uppercase; opacity: 0.8; padding-left: 20px; padding-right: 15px;">
                                    <ul>
                            ...
                            <tr><th style="text-align: justify; text-transform: uppercase; opacity: 0.8; padding-left: 20px; padding-right: 15px;">
                                <p>
                                    Todo material o servicio que no sea solicitado por el área de compras o que no se asigne orden de compra no será pagado.
                                </p>
                            </th></tr>
                            <tr><th style="color: #8d2d00; text-align: justify; text-transform: uppercase; opacity: 0.8; padding-left: 20px; padding-right: 15px;">
                                <p>
                                    HORARIO DE RECEPCION DE MATERIALES. LUNES A VIERNES 11:00 A 15:00
                                </p>
                            </th></tr>
                            <th style="text-align: justify; text-transform: uppercase; font-size: 10px; opacity: 0.7; padding-left: 20px; padding-right: 15px;">
                                <p>&nbsp;*Favor de no repsonder este correo</p>
                            </th>
                            <tr>
                                <td>
